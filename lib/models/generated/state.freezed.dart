...
mixin _$SharedState {
 ...
 SetupParams? get setupParams; VpnOptions? get vpnOptions; String get stopTip; String get startTip; String get currentProfileName; String get currentProxyName; String get mode; String get stopText; bool get onlyStatisticsProxy; bool get crashlytics;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,setupParams,vpnOptions,stopTip,startTip,currentProfileName,currentProxyName,mode,stopText,onlyStatisticsProxy,crashlytics);

@override
String toString() {
  return 'SharedState(setupParams: $setupParams, vpnOptions: $vpnOptions, stopTip: $stopTip, startTip: $startTip, currentProfileName: $currentProfileName, currentProxyName: $currentProxyName, mode: $mode, stopText: $stopText, onlyStatisticsProxy: $onlyStatisticsProxy, crashlytics: $crashlytics)';
}
...
@useResult
$Res call({
 SetupParams? setupParams, VpnOptions? vpnOptions, String stopTip, String startTip, String currentProfileName, String currentProxyName, String mode, String stopText, bool onlyStatisticsProxy, bool crashlytics
});
...
/// Create a copy of SharedState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? setupParams = freezed,Object? vpnOptions = freezed,Object? stopTip = null,Object? startTip = null,Object? currentProfileName = null,Object? currentProxyName = null,Object? mode = null,Object? stopText = null,Object? onlyStatisticsProxy = null,Object? crashlytics = null,}) {
  return _then(_self.copyWith(
...
as String,currentProxyName: null == currentProxyName ? _self.currentProxyName : currentProxyName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String currentProxyName,  String mode,  String stopText,  bool onlyStatisticsProxy,  bool crashlytics)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SharedState() when $default != null:
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.currentProxyName,_that.mode,_that.stopText,_that.onlyStatisticsProxy,_that.crashlytics);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String currentProxyName,  String mode,  String stopText,  bool onlyStatisticsProxy,  bool crashlytics)  $default,) {final _that = this;
switch (_that) {
case _SharedState():
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.currentProxyName,_that.mode,_that.stopText,_that.onlyStatisticsProxy,_that.crashlytics);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String currentProxyName,  String mode,  String stopText,  bool onlyStatisticsProxy,  bool crashlytics)?  $default,) {final _that = this;
switch (_that) {
case _SharedState() when $default != null:
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.currentProxyName,_that.mode,_that.stopText,_that.onlyStatisticsProxy,_that.crashlytics);case _:
  return null;
...
class _SharedState implements SharedState {
  const _SharedState({this.setupParams, this.vpnOptions, required this.stopTip, required this.startTip, required this.currentProfileName, required this.currentProxyName, required this.mode, required this.stopText, required this.onlyStatisticsProxy, required this.crashlytics});
...
@override final  String currentProxyName;
...
/// Create a copy of SharedState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? setupParams = freezed,Object? vpnOptions = freezed,Object? stopTip = null,Object? startTip = null,Object? currentProfileName = null,Object? currentProxyName = null,Object? mode = null,Object? stopText = null,Object? onlyStatisticsProxy = null,Object? crashlytics = null,}) {
